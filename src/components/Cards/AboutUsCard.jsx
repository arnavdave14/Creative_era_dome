        ...
        <div className="w-full max-w-[95vw] mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-4 relative z-30 flex-1">
          ...
          <div className="col-span-1 md:col-span-2 flex flex-col items-start md:items-end pt-4 pb-8 md:pb-0 order-4">
            ...
            <div className="flex flex-col items-start w-full md:pl-4">
              <h2 className="font-drose text-8xl md:text-[8vw] leading-none text-brand-cream mb-2 transition-colors duration-300">01</h2>
              <h3 className="font-drose text-2xl md:text-[1.8vw] leading-[1.1] uppercase text-brand-cream tracking-wide mb-6 transition-colors duration-300">
                BRAND<br/>STRATEGY
              </h3>
            ...
            {/* Bottom White Pill */}
            <div className="mt-16 md:mt-auto bg-brand-cream rounded-xl px-6 py-3 flex items-center justify-center cursor-pointer hover:bg-brand-cream/80 transition-colors duration-300">
               <span className="text-brand-black font-inter text-[10px] md:text-[0.65vw] font-bold tracking-widest uppercase transition-colors duration-300">
                 Creative Era
               </span>
            </div>
