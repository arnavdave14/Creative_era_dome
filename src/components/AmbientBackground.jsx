...
export default function AmbientBackground() {
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[60vw] h-[60vw] ambient-orb-1 pointer-events-none opacity-60" 
           style={{ background: 'radial-gradient(circle, rgba(255,94,0,0.15) 0%, rgba(255,94,0,0) 70%)' }} />
      <div className="absolute bottom-[-20%] right-[-10%] w-[70vw] h-[70vw] ambient-orb-2 pointer-events-none opacity-60" 
           style={{ background: 'radial-gradient(circle, rgba(45,58,32,0.3) 0%, rgba(45,58,32,0) 70%)' }} />
      <div className="absolute top-[20%] left-[30%] w-[50vw] h-[50vw] ambient-orb-3 pointer-events-none opacity-60" 
